...
class PrefsUtil {
  PrefsUtil._(this._preferenceCache);

  static const String _prefix = 'flutter.';
  static Completer<PrefsUtil> _completer;
  ...
  static Future<PrefsUtil> getInstance() async {
    if (_completer == null) {
      final Completer<PrefsUtil> completer =
      Completer<PrefsUtil>();
      try {
        final Map<String, Object> preferencesMap =
        await _getSharedPreferencesMap();
        completer.complete(PrefsUtil._(preferencesMap));
      } on Exception catch (e) {
        // If there's an error, explicitly return the future with an error.
        // then set the completer to null so we can retry.
        completer.completeError(e);
        final Future<PrefsUtil> sharedPrefsFuture = completer.future;
        _completer = null;
  ...
  Future<void> reload() async {
    ...
    await PrefsUtil._getSharedPreferencesMap();
    _preferenceCache.clear();
